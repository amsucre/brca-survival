...
from MGCT.utils.utils import generate_split, nth
from config import TrainConfig

class Generic_WSI_Survival_Dataset(Dataset):
    def __init__(self,
        csv_path = 'dataset_csv/ccrcc_clean.csv', mode = 'omic', apply_sig = True,
        ...
        if self.apply_sig:
            self.signatures = pd.read_csv(TrainConfig.signatures_path)
            self.omic_names = []
