...
from PORPOISE.utils.file_utils import save_pkl
from PORPOISE.utils.core_utils import train
from PORPOISE.utils.utils import get_custom_exp_code
...
def main(args):
	...
	for i in folds:
		...
		if 'omic' in args.mode or args.mode == 'cluster' or args.mode == 'graph' or args.mode == 'pyramid' or args.mode == 'early':
...
parser.add_argument('--data_root_dir',   type=str, default=TrainConfig.features_dir, help='Data directory to WSI features (extracted via CLAM')
parser.add_argument('--seed', 			 type=int, default=1, help='Random seed for reproducible experiment (default: 1)')
parser.add_argument('--k', 			     type=int, default=5, help='Number of folds (default: 5)')
parser.add_argument('--k_start',		 type=int, default=-1, help='Start fold (Default: -1, last fold)')
parser.add_argument('--k_end',			 type=int, default=-1, help='End fold (Default: -1, first fold)')
parser.add_argument('--results_dir',     type=str, default=TrainConfig.results_dir, help='Results directory (Default: ./results)')
...
parser.add_argument('--split_dir',       type=str, default='tcga_brca_final', help='Which cancer type within ./splits/<which_splits> to use for training. Used synonymously for "task" (Default: tcga_blca_100)')
...
parser.add_argument('--mode',            type=str, choices=['omic', 'path', 'pathomic', 'pathomic_fast', 'cluster', 'coattn', 'tissues', 'early'], default='coattn', help='Specifies which modalities to use / collate function in dataloader.')
...
if args.task == 'tcga_brca_survival':
	...
	dataset = Generic_MIL_Survival_Dataset(csv_path = TrainConfig.csv_data_path,
                                           mode = args.mode,
                                           data_dir = TrainConfig.features_dir,
                                           shuffle = False, 
                                           seed = args.seed, 
                                           print_info = True,
                                           patient_strat= False,
...
args.split_dir = TrainConfig.splits_dir_survival
