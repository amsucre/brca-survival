...
### Internal Imports
from MGCT.datasets.dataset_survival import Generic_WSI_Survival_Dataset, Generic_MIL_Survival_Dataset
...
if args.task == 'tcga_brca_survival':
	...
	print(proj)
	dataset = Generic_MIL_Survival_Dataset(csv_path = '/data/tcga_brca.csv',
											mode = args.mode,
                      apply_sig = args.apply_sig,
...
args.split_dir = os.path.join('/data/data_splits/', 'tcga_brca/')
